...
export const metadata = buildMetadata({
  ...
  description: 'Request frozen shrimp samples from Indo Aquatic. Tell us your sector and the products you want to assess — we\'ll arrange samples within 5 working days.',
