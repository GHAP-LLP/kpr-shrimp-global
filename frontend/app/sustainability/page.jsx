...
const COMMITMENTS = [
  ...
  { icon: Leaf, title: "Responsible aquaculture", desc: "Our parent group's farming operations hold BAP and ASC certification, subject to ongoing third-party audit. ASC is now in place across our primary supply operations, covering environmental and social responsibility standards." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-frost-700 leading-relaxed mb-8 font-inter">Our parent group, SS Agro Products, operates prawn farming and processing in Kodavalur, Nellore, Andhra Pradesh — a region with a long history of commercial aquaculture. The practices below represent our current operating standards, subject to ongoing third-party audit.</p>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-white border border-ice-300 rounded-xl p-4 shadow-sm flex flex-col justify-center">
                  <p className="text-xs font-semibold tracking-[0.2em] uppercase text-neon-500 font-inter mb-2">Parent operation</p>
                  <h3 className="font-fraunces text-base text-ink-900 mb-2">SS Agro Products</h3>
                  <p className="text-xs text-frost-700 font-inter leading-relaxed">Kodavalur, Nellore, Andhra Pradesh, India. Farming, processing, and cold storage — integrated with Indo Aquatic UK.</p>
                </div>
              </div>
            </div>
          </div>
