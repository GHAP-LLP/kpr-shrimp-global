...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] bg-frost-900 flex items-center justify-center px-4 py-24">
      <div className="text-center max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/" className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-neon-700 hover:bg-neon-800 text-white font-medium rounded-md transition-colors font-inter">
