    ...
    <div className="bg-frost-900 min-h-screen">
      ...
      <div className="py-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SEO
            title="Products"
            description="Browse KPR Shrimp Global's full range: HOSO, HLSO, PD, IQF cooked, tempura, breaded and more. All count sizes from U/15 to 61/70. UK specialist importer."
            path="/products"
          />
            ...
            {productCategories.map(category => {
              ...
              return (
                <FadeUpItem key={category.id}>
                  <div className="bg-white/5 border border-white/10 rounded-xl p-7 hover:bg-white/[0.08] hover:border-white/20 transition-all duration-200 h-full" data-testid={`category-card-${category.slug}`}>
