...
export const sectors = [
  {
    ...
    description: "Hotels, restaurants, pubs, chains, and caterers need shrimp they can rely on — same count, same yield, same colour, every time. KPR Shrimp Global supplies the full range of formats and pack sizes suited to professional kitchens, from single-site restaurants to national pub chains.",
    ...
    benefits: [
      ...
      { title: "Full range of formats", description: "HOSO for presentation, PD for speed, cooked for cold starters, ready-to-cook for low-skill kitchens." },
  ...
  },
  {
    ...
    description: "Food manufacturers need shrimp that meets precise specification tolerances, delivers consistent yield per batch, and arrives with full traceability documentation. KPR Shrimp Global supplies IQF block and bulk packs for large-scale production, with technical support for NPD.",
  ...
  },
  {
    ...
    description: "Wholesale distributors and cash-and-carry operators need frozen shrimp that sells through — the right pack sizes, the right counts, and a consistent product their customers will reorder. KPR Shrimp Global offers competitive pricing on palletised bulk supply with full documentation.",
  ...
  },
  {
    ...
    description: "Supermarkets and retail buyers seeking own-brand frozen shrimp require a supplier that can match specification to packaging design, provide consistent product quality, and handle all compliance documentation. KPR Shrimp Global offers private label supply for retail own-brand ranges.",
