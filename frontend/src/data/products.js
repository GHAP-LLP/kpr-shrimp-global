...
export const productCategories = [
    ...
    variants: [
      {
        ...
        specs: {
          ...
          certification: "Working towards BAP, ASC",
        },
        useCases: ["Asian restaurant whole-shrimp dishes", "Prawn cocktail and presentation dishes", "Hotel and banquet service", "Fish counter retail displays"],
      },
      {
  ...
  },
  {
    ...
    description: "Fully cooked and IQF-frozen shrimp, ready to use straight from frozen or after a brief thaw. Ideal for cold seafood platters, salads, and retail value-added packs where on-site cooking isn't required.",
    image: IMG.cooked,
    variantCount: 2,
    ...
    variants: [
      ...
      },
      {
        ...
        specs: {
          species: "Litopenaeus vannamei (Whiteleg shrimp)",
          form: "IQF frozen (fully cooked)",
          process: "Cooked, Headless, Shell-On (HLSO)",
        ...
        useCases: ["Cold seafood platters", "Gastropub prawn presentations", "Premium retail frozen packs", "Buffet and catering displays"],
      },
    ],
  },
  {
    ...
    description: "Breaded, battered, marinated, and skewered shrimp, ready to cook from frozen. Developed for foodservice operators who need speed and consistency, and retail buyers seeking consumer-ready value-added products.",
    ...
    variants: [
      {
        id: "tempura-battered", slug: "tempura-battered", name: "Tempura", fullName: "Tempura Battered Shrimp",
        description: "Whiteleg shrimp in a light, crispy Japanese-style tempura batter. Cooks in 3–4 minutes from frozen. The tempura coating provides a delicate crunch without heaviness, suitable for quick-serve and premium foodservice menus.",
        image: IMG.readyToCook,
        specs: {
          species: "Litopenaeus vannamei (Whiteleg shrimp)",
      ...
      },
      {
        ...
        specs: {
          ...
          shrimpPerSkewer: "4–6 shrimp per skewer (approx. 80–120 g)",
